    ...
    <body>
        ...
        <div class="container" style="background-color: rgba(17, 14, 14, 0.8);">
            ...
            <?php if($contest->win === null && $contest->characters[0]->user_id == auth()->id()): ?>
                <h2>Actions</h2>
                <form method="POST"
                    action="<?php echo e(route('contest.attack', ['contest' => $contest, 'attackType' => 'melee'])); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit" name="action" value="melee">Melee Attack</button>
                </form>

                <form method="POST"
                    action="<?php echo e(route('contest.attack', ['contest' => $contest, 'attackType' => 'ranged'])); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit" name="action" value="ranged">Ranged Attack</button>
                </form>

                <form method="POST"
                    action="<?php echo e(route('contest.attack', ['contest' => $contest, 'attackType' => 'special'])); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/vargaboldizsar/Desktop/laravel copy 8/beadando/resources/views/contest.blade.php ENDPATH**/ ?>